  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form method="POST" enctype="multipart/form-data" action="{{ route('payment.update', ['id' => $payment->id]) }}">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Edit Data Pembayaran {{$payment->payment_amount}}</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                              ...
                                              <input id="payment_amount" type="text" class="form-control" name="payment_amount" placeholder="Jumlah Pembayaran" value="{{$payment->payment_amount}}" >
                                            </div>
                                            <div class="form-group">
                                              <label for="name">Bukti Transfer</label>
                                              <input id="transfer_slip" type="file" class="form-control" name="transfer_slip" placeholder="Bukti Transfer" value="{{$payment->transfer_slip}}" >
                                            </div>
                                            <div class="form-group">
