                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="admin_name" type="text" class="form-control" name="admin_name" placeholder="Nama Admin" >
                            </div>
                            <div class="form-group">
                                <label for="name">Nama Bank</label>
                                <input id="bank_name" type="text" class="form-control" name="bank_name" placeholder="Nama Bank" >
                            </div>
                            <div class="form-group">
                                <label for="name">Nomor Rekening</label>
                                <input id="rekening_number" type="text" class="form-control" name="rekening_number" placeholder="Nomor Rekening" >
                            </div>
                            <div class="form-group">
                                <label for="name">A/N Bank</label>
                                <input id="bank_personal_name" type="text" class="form-control" name="bank_personal_name" placeholder="A/N Bank" >
                            </div>
