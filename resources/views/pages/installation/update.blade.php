...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('installation')}}" class="nav-link">Back</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <form method="POST" action="{{ route('installation.update', ['id' => $installation->id]) }}">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Edit Data Pemasangan {{$installation->installation_date}}</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="name">Tanggal Pemasangan</label>
                                                <input id="installation_date" type="date" class="form-control" name="installation_date" placeholder="Y-M-D" value="{{$installation->installation_date}}" >
                                            </div>
