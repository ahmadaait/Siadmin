  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Create Data Installation</h1>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
    <div class="col-12">
        <form method="POST" action="{{route('installation.submit')}}">
            <div class="card">
                <div class="card-header">
                    <h4>Form Pemasangan</h4>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control  p-1" id="type" name="group_id">
                            ...
                            <div class="form-group">
                                ...
                                <input id="installation_date" type="date" class="form-control" name="installation_date" placeholder="Y-m-d" >
                            </div>
